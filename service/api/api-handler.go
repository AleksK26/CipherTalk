...
func (rt *_router) Handler() http.Handler {
	...
	rt.router.DELETE("/groups/:groupId/members/:userId", rt.wrap(rt.removeMember))
	...
	rt.router.DELETE("/conversations/:conversationId/members/me", rt.wrap(rt.leaveConversation))
